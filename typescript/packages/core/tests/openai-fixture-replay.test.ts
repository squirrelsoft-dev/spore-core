/**
 * Fixture replay for the OpenAI basic-text exchange recorded in
 * `fixtures/model_responses/model_interface/openai_basic_text.jsonl`.
 *
...
describe("ReplayModelInterface — openai_basic_text.jsonl", () => {
